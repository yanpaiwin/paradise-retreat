                ...
                >
                    ...
                    <div className="border-t border-gray-200 pb-1 pt-4 dark:border-gray-600">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            <button
                                onClick={handleLogout}
                                className="block w-full px-4 py-2 text-start text-base font-medium text-gray-500 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200 dark:focus:bg-gray-800 dark:focus:text-gray-200"
                            >
                                Log Out
                            </button>
                        </div>
